...
namespace Tello.App.ViewModels
{
    public class TelloVideoViewModel : ViewModel
    {
        ...
        public TelloVideoViewModel(IUIDispatcher dispatcher, IUINotifier userNotifier, IVideoSampleReadyNotifier videoSampleReadyNotifier, IVideoSampleProvider videoSampleProvider) : base(dispatcher, userNotifier)
        {
